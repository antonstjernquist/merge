...
echo ""
echo "Send tasks with targeting:"
echo "  ${CLI_NAME} send \"Task title\" --blocking                    # Any worker can accept"
echo "  ${CLI_NAME} send \"Task title\" --to AgentName --blocking     # Route to specific agent"
echo "  ${CLI_NAME} send \"Task title\" --to-skill testing --blocking # Route by skill"
echo "  ${CLI_NAME} send \"Task title\" --broadcast                   # Send to all workers"
echo ""
echo "Help:"
echo "  ${CLI_NAME} --help"
